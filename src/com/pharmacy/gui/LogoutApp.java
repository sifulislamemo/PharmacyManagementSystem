 ...
 * @author USER
 */
public class LogoutApp extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LogoutApp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
